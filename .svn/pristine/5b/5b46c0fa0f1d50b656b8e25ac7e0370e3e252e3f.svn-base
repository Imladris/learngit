...
return array(
    ...
    'WECHAT_APPID' => "wx2c89c47656de2d93",     //AppID(应用ID) 为了安全只有在使用的时候设置
    'WECHAT_APPSECRET' => "c6bb2f14fcda3f9fc02758bc0c3d422f",      //AppSecret(应用密钥)
	/* 'WECHAT_TOKEN' => "xxxxxx", */
    /* 'WECHAT_APPID' => "xxxxxx",      //AppID(应用ID) 为了安全只有在使用的时候设置 */
    /* 'WECHAT_APPSECRET' => "xxxxxx",      //AppSecret(应用密钥) */

    'BAIDUAPI_KEY' => "de9be01b4046a634ea5d7046cc4d8043",   //百度api接口
    /* 'BAIDUAPI_KEY' => "",   //百度api接口 */

    'QUERYCET_LINK' => "http://cet.zy62.com/query/1",   //四级查询接口
    /* 'QUERYCET_LINK' => "",   //四级查询接口 */

    'QUERYLIBRARY_LINK' => "http://120.27.53.146/cityuit/index.php/Home/Campus/appLibrary",   //图书查询接口
